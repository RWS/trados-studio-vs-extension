...
so the version from TemplatesVSIX\Packages\Sdl.Core.PluginFramework.1.8.0.nupkg and TemplatesVSIX\Packages\Sdl.Core.PluginFramework.Build.15.1.0.nupkg 
